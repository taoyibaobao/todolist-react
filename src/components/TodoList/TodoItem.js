...
class TodoItem extends Component {
  ...
  render() {
    const { item, index, handleItemDelete, handleChangeEditStatus, handleChangeDone, handleEditChange, handleSaveValue } = this.props;
    ...
    return <li key={index}>
      {item.isEdit ? (
        <>
          ...
          <div>
            <button
              onClick={() => handleSaveValue(index, item.value)}
            >
              保存
            </button>
